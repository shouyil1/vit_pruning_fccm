...
##################################################
##### Copied from HuggingFace, Duplicate #########
##################################################
...
####################### DP: NOTE ##########################################################
#### PyTorch uses N, C, H, W for images ###################################################
#### PyTorch uses B, N, D for sequences ###################################################
#### B -> batch size, N -> sequence length/tokens, D -> embedding/hidden dimension ########
###########################################################################################

####################### DP: NOTE #############################################################################################
### Linear params stored as -----> output_neurons X params_per_neuron ########################################################
### This indicates that parameter for each head is stacked one on top of the other, vertically (and not besides each other) ##
### More precisely: (HEADS*PER_HEAD_NEURONS) X (PER_NEURON_PARAMS) ###########################################################
##############################################################################################################################
...
#### DP: Support provided to DELETE redundancy in terms of redundant heads #####
#### DP: Used ONLY for MSA parameters Q, K, V, O
...
###### DP: SubEncoder/Encoder/Single-Encoder-Block ################
