...
from deit_blockprune_trainer import DeiTSparseTrainingArguments, DeiTModelPatchingCoordinator
...
class TestFun(TestCase):
    def helper(self, sparse_args, model_name_or_path):
        ...
        coordinator = DeiTModelPatchingCoordinator(sparse_args, device, cache_dir, model_name_or_path, logit_names, teacher_constructor)

        return config, model, coordinator

    def test_base(self):
        sparse_args = DeiTSparseTrainingArguments.hybrid(20.0)
