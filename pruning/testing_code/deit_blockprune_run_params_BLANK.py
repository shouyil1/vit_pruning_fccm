...
attention_block_rows = 64                                                                   #### <SET> ####
attention_block_cols = 64                                                                   #### <SET> ####
...
if model_to_utilize_for_experiment == "deit_drop_tokens_variant_i":
    ...
    layer_type_context_for_token_dropping = "default" if (list(info_dict_for_token_dropping.keys()) == [1, 4, 7]) else "non-default"
